...
If you defined a class <code class="docutils literal"><span class="pre">C</span></code> that subclasses <code class="docutils literal"><span class="pre">A</span></code> and <code class="docutils literal"><span class="pre">B</span></code> like <code class="docutils literal"><span class="pre">C(A,</span> <span class="pre">B)</span></code>, <code class="docutils literal"><span class="pre">attrs</span></code> would have collected the attributes from <code class="docutils literal"><span class="pre">B</span></code> <em>before</em> those of <code class="docutils literal"><span class="pre">A</span></code>.</p>
<p>This is now fixed and means that in classes that employ multiple inheritance, the output of <code class="docutils literal"><span class="pre">__repr__</span></code> and the order of positional arguments in <code class="docutils literal"><span class="pre">__init__</span></code> changes.
Due to the nature of this bug, a proper deprecation cycle was unfortunately impossible.</p>
<p>Generally speaking, it’s advisable to prefer <code class="docutils literal"><span class="pre">kwargs</span></code>-based initialization anyways – <em>especially</em> if you employ multiple inheritance and diamond-shaped hierarchies.</p>
...
<li><p class="first">The <code class="docutils literal"><span class="pre">__repr__</span></code> set by <code class="docutils literal"><span class="pre">attrs</span></code>
no longer produces an <code class="docutils literal"><span class="pre">AttributeError</span></code>
when the instance is missing some of the specified attributes
(either through deleting
or after using <code class="docutils literal"><span class="pre">init=False</span></code> on some attributes).</p>
<p>This can break code
that relied on <code class="docutils literal"><span class="pre">repr(attr_cls_instance)</span></code> raising <code class="docutils literal"><span class="pre">AttributeError</span></code>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">has_unset_members</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
...
<ul>
<li><p class="first">The <code class="docutils literal"><span class="pre">attr.ib(convert=callable)</span></code> option is now deprecated in favor of <code class="docutils literal"><span class="pre">attr.ib(converter=callable)</span></code>.</p>
<p>This is done to achieve consistency with other noun-based arguments like <em>validator</em>.</p>
<p><em>convert</em> will keep working until at least January 2019 while raising a <code class="docutils literal"><span class="pre">DeprecationWarning</span></code>.</p>
...
<ul>
<li><p class="first">Generated <code class="docutils literal"><span class="pre">__hash__</span></code> methods now hash the class type along with the attribute values.
...
<li><p class="first"><code class="docutils literal"><span class="pre">attr.ib</span></code>’s <code class="docutils literal"><span class="pre">metadata</span></code> argument now defaults to a unique empty <code class="docutils literal"><span class="pre">dict</span></code> instance instead of sharing a common empty <code class="docutils literal"><span class="pre">dict</span></code> for all.
The singleton empty <code class="docutils literal"><span class="pre">dict</span></code> is still enforced.</p>
<p><a class="reference external" href="https://github.com/python-attrs/attrs/issues/280">#280</a></p>
</li>
<li><p class="first"><code class="docutils literal"><span class="pre">ctypes</span></code> is optional now however if it’s missing, a bare <code class="docutils literal"><span class="pre">super()</span></code> will not work in slots classes.
...
<li><p class="first">Subclasses of <code class="docutils literal"><span class="pre">auto_attribs=True</span></code> can be empty now.</p>
...
<li><p class="first">All generated methods now have correct <code class="docutils literal"><span class="pre">__module__</span></code>, <code class="docutils literal"><span class="pre">__name__</span></code>, and (on Python 3) <code class="docutils literal"><span class="pre">__qualname__</span></code> attributes.</p>
...
<p><code class="docutils literal"><span class="pre">attrs</span></code> is written and maintained by <a class="reference external" href="https://hynek.me/">Hynek Schlawack</a>.</p>
...
<ul>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../../../../../_sources/doctmp/lib/python3.5/site-packages/attrs-17.4.0.dist-info/DESCRIPTION.rst.txt"
...
<script type="text/javascript">$('#searchbox').show(0);</script>
    ...
    <div class="footer">
      ...
      |
      <a href="../../../../../_sources/doctmp/lib/python3.5/site-packages/attrs-17.4.0.dist-info/DESCRIPTION.rst.txt"
