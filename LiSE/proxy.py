...
class EngineHandle(object):
    ...
    def character_stat_copy(self, char):
        return {
            k: unwrap_character_stat(char, k, v)
    ...
    def node_stat_copy(self, char, node):
        ...
        return {
            k: unwrap_node_stat(char, node, k, v)
    ...
    def portal_stat_copy(self, char, o, d):
        return {
            k: unwrap_portal_stat(char, o, d, k, v)
...
class CachingEntityProxy(CachingProxy):
    def _cache_munge(self, k, v):
        return self._engine.json_rewrap(v)
...
class SuccessorsProxy(CachingProxy):
    ...
    def __eq__(self, other):
        return (
            ...
            self._engine is other._engine and
            self._charname == other._charname and
...
class CharSuccessorsMappingProxy(CachingProxy):
    ...
    def __eq__(self, other):
        return (
            ...
            other._engine is self.engine and
    ...
    def listener(self, fun):
        self._engine.portal_map_listener(self.name, fun)

    def unlisten(self, fun):
        self._engine.portal_map_unlisten(self.name, fun)
