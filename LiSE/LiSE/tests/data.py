...
KEYFRAME0 = {
	...
	"node_val": {
		"hello": {
			"bye": {"name": "bye", "toodles": False},
			"earth": {"name": "earth"},
			"evening": {"location": "bye", "moon": 1.0, "name": "evening"},
			"hello": {"name": "hello", "you": "smart"},
			"hi": {"name": "hi", "no": "very no", "tainted": True},
			"me": {"location": "hi", "name": "me"},
			"moon": {
				"location": "evening",
				"name": "moon",
				"phase": "waxing gibbous",
			},
			"neal": {"location": "moon", "name": "neal"},
		}
	},
	"nodes": {
		"astronauts": {},
...
KEYFRAME1 = {
	...
	"graph_val": {"hello": {"stat": "also"}, "physical": {"name": "physical"}},
	"node_val": {
		"physical": {
			(0, 0): {"name": (0, 0)},
			(0, 1): {"name": (0, 1)},
