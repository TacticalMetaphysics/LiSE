...
YY_BUFFER_STATE igraph_pajek_yy_scan_bytes (yyconst char *bytes,int len ,yyscan_t yyscanner );
...
#line 626 "foreign-pajek-lexer.c"
...
#line 873 "foreign-pajek-lexer.c"
...
ECHO;
	YY_BREAK
#line 1332 "foreign-pajek-lexer.c"
 ...
 * @return the newly allocated buffer state object.
 */
YY_BUFFER_STATE igraph_pajek_yy_scan_bytes  (yyconst char * yybytes, int  _yybytes_len , yyscan_t yyscanner)
{
	YY_BUFFER_STATE b;
	char *buf;
	yy_size_t n;
