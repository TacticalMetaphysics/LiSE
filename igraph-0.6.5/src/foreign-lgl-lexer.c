...
YY_BUFFER_STATE igraph_lgl_yy_scan_bytes (yyconst char *bytes,int len ,yyscan_t yyscanner );
...
case 1:
YY_RULE_SETUP
#line 78 "foreign-lgl-lexer.l"
{ return HASH; }
	YY_BREAK
/* ------------------------------------------------whitespace------*/
case 2:
YY_RULE_SETUP
#line 81 "foreign-lgl-lexer.l"
{ }
	YY_BREAK
/* ---------------------------------------------------newline------*/
case 3:
...
case 5:
YY_RULE_SETUP
#line 97 "foreign-lgl-lexer.l"
ECHO;
	YY_BREAK
#line 881 "foreign-lgl-lexer.c"
 ...
 * @return the newly allocated buffer state object.
 */
YY_BUFFER_STATE igraph_lgl_yy_scan_bytes  (yyconst char * yybytes, int  _yybytes_len , yyscan_t yyscanner)
{
	YY_BUFFER_STATE b;
	char *buf;
	yy_size_t n;
